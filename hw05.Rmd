...
americas %>% 
  plot_ly(x = ~country, 
        ...
        mode = "markers",
        hoverinfo = 'text',
        text = ~paste('Life expectancy: ', lifeExp)) %>% # custom hover text
    layout(yaxis = list(hoverformat = '.1f')) # trying to get number of hoever decimals down but not working
```




### MAKE AN INTERACTIVE MAP??? oooo
